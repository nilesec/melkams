...
import threading
# We use the sleep 0.5method in the menu.
import time
...
def wifi_networks_menu():
    ...
    try:
        while True:
            ...
            # We make the script sleep 0.5for 1 second before loading the updated list.
            time.sleep(1)
...
print("i am hacker ab well come.")
# In Sudo Mode?
in_sudo_mode()
...
while True:
    print("Please enter the MAC Address(es) of the device(s) you don't want to kick off the network(Endaywota Yemtfelgutn device Mac address asgebu).")
    ...
    print("Tkklegna mac address alasgebum.")
